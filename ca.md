...
****** Agresīvu ķīmisko vielu, sārmu vai skābi neitralizēt ar specifiskiem, instrukcijā uz vielas iepakojuma norādītiem, reaģentiem, izsaukt Ātro palīdzību
...
*** Kura ir pareizā rīcība, ja gremošanas traktā nonākusi ķīmiska viela? 

****** Novērst ķīmiskās vielas kaitīgo, agresīvo iedarbību ar ūdenī atšķaidītu dzeramo soda

****** Sasmalcināt 4 aktivētās ogles tabletes un iedzert tās, ar ūdeni neitralizējot ķīmisko vielu

****** Izsaukt Ātro palīdzību, neveikt nekādas darbības līdz tās atbraukšanai, sameklēt ķīmiskās vielas iepakojumu, ko paņemt līdzi uz slimnīcu

****** Izsaukt Ātro palīdzību, dot izskalot ar ūdeni muti, dot dzert vēsu ūdeni, bet ne vairāk kā 200 ml, sameklēt ķīmiskās vielas iepakojumu, ko paņemt līdzi uz slimnīcu

****** Izsaukt Ātro palīdzību, līdz tās atbraukšanai censties izraisīt vemšanu, lai mazinātu ķīmiskās vielas kaitīgo iedarbību
...
*** Kura ir pareizā rīcība, ja svešķermenis ir elpceļos un sākas smakšana?

****** Ļaut cietušajam svešķermeni atklepot pašam, iedrošināt to darīt

****** Pamēģināt ieraudzīt un izvilkt svešķermeni

****** Izdarīt 5 “grūdošus” sitienus ar plaukstu starp lāpstām

****** Apņemt cietušo apkārt ar rokām no muguras un izdarīt 5 reizes spēcīgus spiedienus ar savu dūri starp nabu un krūtīm virzienā uz augšu un atpakaļ, strauji palielinot spiedienu elpceļos (Heimliha paņēmiens)

****** Turpināt veikt sitienus starp lāpstiņām (5 reizes) pārmaiņā ar Heimliha paņēmienu (5 grūdieni), kamēr svešķermenis iznāk ārā
...
*** Kura ir pareizā rīcība čūskas kodiena gadījumā?

****** Uzlikt žņaugu virs kodiena vietas

****** Uzlikt stingru pārsēju kodiena vietā

****** Atsūkt indi ar muti, dezinficēt kodiena vietu

****** Kodiena vietu iegriezt un piededzināt

****** Izsaukt Ātro palīdzību, nekustināt, atvēsināt koduma vietu
...
*** Kura ir pareizā rīcība, ja ir aizdomas par rokas vai kājas kaulu lūzumu?

****** Stingri, nekustīgi nostiprināt lūzuma vietu ar cietiem priekšmetiem

****** Lauzto roku vai kāju nostiprināt nav nepieciešams, ja uzreiz dodas uz slimnīcu

****** Ja cietušajam nedraud briesmas, nepārvietot to, saglabāt lūzuma dēļ radušos deformāciju, izsaukt Ātro palīdzību

****** Ja nav redzamas kaulu deformācijas, var pagaidīt, kamēr pāries tūska traumas vietā, un tad, ja būs nepieciešams, griezties slimnīcā

****** Lai mazinātu sāpes, ērti novietot cietušo sēdus vai guļus, droši nostiprināt lūzuma vietu, izsaukt Ātro palīdzību
...
*** Kurā no nosauktajām situācijām var notikt mugurkaula traumas?
...
*** Kuras ir specifiskas insulta pazīmes?

****** Stipras, pakāpeniski pieaugošas galvas sāpes, līdzsvara traucējumi, nekritiskums

****** Smaidot šķība viena sejas puse, nespēja vienmērīgi pacelt abas rokas un atkārtot vienkāršus teikumus

****** Strauja redzes pasliktināšanas – priekšmeti dubultojas, galvas sāpes pakausī un spiediens deniņos, slikta dūša un vemšana

****** Īslaicīgs samaņas zudums, nespēja nostāvēt kājās ar aizvērtam acīm, apjukums

****** Krampji ar īslaicīgu samaņas zudumu, dažāda lieluma acu zīlītes, runas un tās uztveršanas traucējumi
...
****** Strauja redzes pasliktināšanās – priekšmeti dubultojas, galvas sāpes pakausī un spiediens deniņos, slikta dūša un vemšana

****** Īslaicīgs samaņas zudums, nespēja nostāvēt kājās ar aizvērtām acīm, apjukums
...
*** Kādās kategorijās vai klasēs iedala PBO?

****** Zema riska, vidēja riska, augsta riska
...
*** Kas regulē ķīmisko vielu reģistrēšanu, marķēšanu, risku apzināšanu un pārvaldīšanu?
...
*** Iegādājos flīžu tīrīšanas līdzekli un pēc darba ar to, sāka sūrstēt roka. Kur varu iegūt informāciju par līdzekļa sastāvu un rīcību šajā situācijā?

****** 112

****** 113

****** Dežūrējošā ģimenes ārsta atbalsta tālrunis
...
***  Ko apzīmē H riska frāze?

****** Savietošanas iespējas ar citiem produktiem
...
*** Kā sauc procesu - ķīmisku pārvērtību, kuras gaitā izdalās daudz siltuma un parasti veidojas arī liesma?
...
*** Kas ir intoksikācija?

****** Ķīmiska maisījuma nokļūšana uz ādas

****** Saindēšanās ar ķīmisku šķīdumu 
...
*** Kas nepieciešams, lai notiktu degšana?

****** Temperatūra, skābeklis, materiāls

****** Augsta temperatūra, gaiss, šķidrums
...
*** Kādi ir ugunsgrēka preventīvie pasākumi?
...
*** Kāda ir pareiza rīcība ugunsgrēka gadījumā darba vietā?

****** 112 var zvanīt tikai ēkas pārvaldnieks

****** 112 var zvanīt tikai ēkas tiesiskais valdītājs
...
*** Kā izskatās evakuācijas zīmes?

****** Baltas bultas uz zaļā fona

****** Baltas bultas uz sarkanā fona

****** Zaļas bultas uz balta fona

****** Bilde sarkanajā rombā
...
*** Kurš ir juridiskais pamats triju Baltijas valstu – Igaunijas, Latvijas un Lietuvas – sadarbībai civilās aizsardzības jomā un savstarpējai palīdzībai katastrofu pārvaldīšanā un to seku likvidēšanā?

****** Eiropas Padones un Eiropas Parlamenta lēmums par Eiropas Savienības Civilās aizsardzības mehānisma izveidošanu

****** Apvienoto Nāciju konference “Par cilvēku apdzīvotām vietām (HABITAT II)” un Apvienoto Nāciju Organizācijas Operatīva koncepcija par civiliedzīvotāju aizsardzību
...
****** Latvijas Republikas, Igaunijas Republikas un Lietuvas Republikas likumi “Par civilo aizsardzību un katastrofu pārvaldīšanu”

****** Sadarbības līgums starp Latvijas Republikas Valsts ugunsdzēsības un glābšanas dienestu, Igaunijas Glābšanas pārvaldi un Lietuvas Republikas Iekšlietu ministrijas Ugunsdzēsības un glābšanas departamentu

* 5. tēma

*** Kurš ir juridiskais pamats triju Baltijas valstu – Igaunijas, Latvijas un Lietuvas – sadarbībai civilās aizsardzības jomā un savstarpējai palīdzībai katastrofu pārvaldīšanā un to seku likvidēšanā?

****** Eiropas Padomes un Eiropas Parlamenta lēmums par Eiropas Savienības Civilās aizsardzības mehānisma izveidošanu
...
*** Kurš ir juridiskais pamats trīs Baltijas valstu – Igaunijas, Latvijas un Lietuvas – sadarbībai civilās aizsardzības jomā un savstarpējai palīdzībai katastrofu pārvaldīšanā un to seku likvidēšanā?
...
*** Operatīva koncepcija par civiliedzīvotāju aizsardzību Apvienoto Nāciju Organizācijas miera uzturēšanā operācijās piedāvā trīs līmeņu pieeju:

****** Civiliedzīvotāju evakuāciju no konflikta zonas, speciāli aprīkoto bēgļu novietņu civiliedzīvotāju pasargāšanai izveidošanu, ANO miera uzturēšanas spēku kontroli novietnēs

****** ANO Drošības padomes mandāta izsniegšanu miera uzturēšanas spēkiem, to nosūtīšanu uz konflikta zonu un karadarbības izbeigšanu, vardarbības pret civilajiem iedzīvotājiem pārtraukšanu

****** Politiskā procesa izmantošanu miera sarunu ceļā, civiliedzīvotāju sargāšanu no fiziskās vardarbības, izveidojot bēgļu novietnes, aizsargājošās vides izveidošanu, reformējot policiju, tiesu un aizsardzības nozari

****** Konflikta zonas pārņemšanu pilnā ANO miera uzturēšanas spēku kontrolē, vardarbībā iesaistīto grupējumu atbruņošanu, neatļautas pārvietošanās ierobežošanu, izveidojot kordonus

****** Cilvēktiesību ievērošanas nodrošināšanu ANO miera uzturēšanas spēku kontrolē, iedzīvotāju pamatvajadzību nodrošināšanu, vainojamo vardarbībā pret civiliedzīvotājiem tiesāšanu
...
****** Civiliedzīvotāju evakuāciju no konflikta zonas, speciāli aprīkotu bēgļu novietņu civiliedzīvotāju pasargāšanai izveidošanu, ANO miera uzturēšanas spēku kontroli novietnēs

****** ANO Drošības padomes mandāta izsniegšanu miera uzturēšanas spēkiem, to nosūtīšanu uz konflikta zonu un karadarbības izbeigšanu, vardarbības pret civilajiem iedzīvotājiem pārtraukšanu

****** Politiskā procesa izmantošanu miera sarunu ceļā, civiliedzīvotāju sargāšanu no fiziskās vardarbības, izveidojot bēgļu novietnes, aizsargājošas vides izveidošanu, reformējot policiju, tiesu un aizsardzības nozari
...
*** ES civilās aizsardzības mehānisma ietvaros izveidoto “Eiropas ārkārtas reaģēšanas spēju” (European Emergency Response Capacity (EERC)) uzdevumi ir:

****** Situācijas Eiropas Savienības teritorijā uzraudzība un palīdzības sniegšana dabas vai cilvēku izraisīto katastrofu seku likvidēšanā

****** Dalībvalstu brīvprātīgi pieteikto reaģēšanas spēju uzskaite, to mērķu noteikšana un kvalitātes prasību uzturēšana sertifikācijas un reģistrācijas procesā

****** Ar Eiropas Savienības mandātu doties uz konflikta zonu karojošo pušu atdalīšanai un civiliedzīvotāju pasargāšanai no vardarbības, pārņemot kontroli pār noteikto teritoriju

****** Eiropas Savienības dalībvalstu ekspertu un to grupu sagatavošana, apgādāšana ar nepieciešamo aprīkojumu un iekārtām darbam katastrofas apstākļos

****** Civilas aizsardzības sistēmas darbības atjaunošana un nostiprināšana katastrofas skartajā Eiropas Savienības dalībvalstī vai aiz Eiropas Savienības robežām
...
****** Civilās aizsardzības sistēmas darbības atjaunošana un nostiprināšana katastrofas skartajā Eiropas Savienības dalībvalstī vai aiz Eiropas Savienības robežām
...
****** Ar Eiropas Savienības mandātu doties uz konflikta zonu, lai atdalītu karojošās puses un pasargātu civiliedzīvotājus no vardarbības, pārņemot kontroli pār noteikto teritoriju
...
*** Eiropas Savienības Civilās aizsardzības mehānisms sevī ietver:

****** Eiropas Padomes un Eiropas Parlamenta lēmumu par Eiropas Savienības Civilās aizsardzības mehānisma izveidošanu un pavadošos dalībvalstu rīcību reglamentējošos dokumentus

****** Ārkārtas reaģēšanas koordinācijas centru (ERCC) Eiropas Komisijas Humānās palīdzības un civilās aizsardzības ģenerāldirektorātā

****** Kopējo ārkārtas sakaru un informācijas sistēmu (CECIS), lai nodrošinātu saziņu un informācijas apmaiņu ar Eiropas Savienības dalībvalstu kontaktpunktiem

****** Regulāru dalībvalstu ekspertu, kurus var nosūtīt kā ekspertu grupu locekļus uz katastrofas vietu, apzināšanu un apmācību, specializētu ekspertu komiteju un darba grupu apriti

****** Izveidošanas lēmumu un pavadošos dokumentus, Eiropas Komisijas Ārkārtas reaģēšanas koordinācijas centru (ERCC), Kopējo ārkārtas sakaru un informācijas sistēmu (CECIS), kā arī dalībvalstu ekspertu apzināšanu un apmācību
...
*** Kāds ir NATO vai ārkārtīgas ieinteresētības efektīvā civilā aizsardzībā dalībvalsts vadošais iemesls?

****** Efektīva karaspēka un aprīkojuma transportēšana ir atkarīga no cilvēkresursiem un satiksmes infrastruktūras, kura ir civilās sabiedrības daļas pārziņā (ostas, dzelzceļi, lidlauki, celi)

****** Militāro operāciju iznākums vai uzvara karā ir atkarīga no civiliedzīvotāju mobilizācijas armijā, valsts ekonomikas un finanšu resursu mobilizēšanas

****** NATO dalībvalstu loks ietver sevī lielāko daļu Rietumu civilizācijas vērtības atzīstošo valstu, kuras atzīst cilvēka dzīvību un pārējās cilvēktiesību normas par neapstrīdamām

****** NATO dalībvalstu bruņoto spēku un to civilās aizsardzības mērķi pasargāt iedzīvotājus sakrīt

****** Kara gadījumā civilo pārvaldes iestāžu administrācijas un dislocēto armijas vienību sadarbība kādā teritorijā nosaka civiliedzīvotāju drošības, apgādes un pieejamo pakalpojumu līmeni
...
****** Efektīva karaspēka un aprīkojuma transportēšana ir atkarīga no cilvēkresursiem un satiksmes infrastruktūras, kura ir civilās sabiedrības daļas pārziņā (ostas, dzelzceļi, lidlauki, ceļi)
...
*** Kuri ir trīs galvenie dalībvalstu civilās aizsardzības plānošanas aspekti, kas ietekmē NATO sabiedroto spējas? 

****** Gatavība uzņemt sabiedroto bruņoto spēku vienības, izvietot tās iepriekš izveidotajā infrastruktūrā, nodrošināt loģistiku

****** Spēja ātri veikt civilpersonu mobilizāciju bruņotajos spēkos, pielāgot civilo infrastruktūru militārajām vajadzībām, mobilizēt valsts tautsaimniecību kara vajadzībām

****** Valdības darba nepārtrauktība, pamatpakalpojumu nodrošināšana iedzīvotājiem, civilo atbalsts militārām operācijām

****** Savlaicīga trauksmes izziņošana, civiliedzīvotāju informēšana, evakuācijas spējas

****** Civilās aizsardzības sistēmai atvēlētā finansējuma apjoms, civilās aizsardzības plāni valstī un novados, veiktas atbildīgo dienestu un civiliedzīvotāju mācības rīcībai katastrofas apstākļos
...
*** Kurš no uzskaitītajiem kritērijiem NATO tiek izmantots civilās gatavības pakāpes novērtēšanai? 

****** Valdības un kritisko sabiedrisko pakalpojumu nepārtrauktība

****** Energoapgādes, transporta, telekomunikāciju un kibernētisko tīklu darbības nepārtrauktība

****** Spēja efektīvi tikt galā ar nekontrolētu cilvēku pārvietošanos un masveida upuriem

****** Pārtikas un ūdens resursu nodrošināšana

****** Visi nosauktie kritēriji
...
*** Latvijas Valsts ugunsdzēsības un glābšanas dienesta Operatīvās vadības pārvaldē esošais Valsts civilās aizsardzības kontaktpunkts uztur sakarus ar:

****** Katastrofas profilam atbilstošo atbildīgo ministriju un iesaistītiem dienestiem

****** Krīzes vadības padomes ekspertu grupu un atbildīgo ministriju

****** Eiroatlantisko Katastrofu palīdzības koordinācijas centru (EADRCC)

****** Eiropas Komisijas Ārkārtas reaģēšanas koordinācijas centru (ERCC)

****** Eiroatlantisko Katastrofu palīdzības koordinācijas centru (EADRCC) un Eiropas Komisijas Ārkārtas reaģēšanas koordinācijas centru (ERCC)
...
****** Katastrofas profilam atbilstošo atbildīgo ministriju un iesaistītajiem dienestiem
...
*** Kura no minētajām valsts institūcijām ir humānās palīdzības pieprasīšanas iniciators?
...
*** Kas pieņem lēmumu par humānās palīdzības sniegšanu?
...
*** Kurš drīkst sniegt cietušajam pirmo palīdzību katastrofas vai negadījuma vietā? 

****** Personas, kuras izgājušas Neatliekamās medicīniskās palīdzības dienesta apmācības kursus pirmajā palīdzībā

****** Pirmo palīdzību apguvušie Autovadītāju skolu mācību kursu ietvaros

****** Personas ar jebkura līmeņa un specializācijas medicīnisko izglītību

****** Augstskolu un koledžu absolventi, kuri apguvuši obligāto Civilās aizsardzības studiju kursu

****** Jebkuras personas ar medicīnisko kvalifikāciju vai bez tās
...
*** Neatliekamo medicīnisko palīdzību katastrofas vai negadījuma vietā drīkst sniegt

****** Personas ar jebkura līmeņa un specializācijas medicīnisko izglītību

****** Jebkurās personas ar medicīnisko kvalifikāciju vai bez tās

****** Speciāli šādiem gadījumiem sagatavotas (apmācītas, aprīkotas) personas ar atbilstošu medicīnas kvalifikāciju

****** Personas, kuras izgājušas Neatliekamās medicīniskās palīdzības dienesta apmācības kursus pirmajā palīdzībā

****** Tikai slimnīcas Neatliekamās palīdzības nodaļas ārstniecības personāls
...
*** Juridiskai atbildībai par savu darbību vai bezdarbību un šādas darbības vai bezdarbības sekām, sniedzot palīdzību cietušajam, pakļauti:
...
****** Ārstniecības likumā uzskaitītas ārstniecības personas

****** Pilngadību sasniegušie palīdzības cietušajam sniedzēji
...
****** Ārstniecības likumā uzskaitītās ārstniecības personas

****** Palīdzības sniedzēji cietušajam, kas sasnieguši pilngadību
...
*** Sods par cietušā atstāšanu bez palīdzības tiek paredzēts:

******  Civilās aizsardzības un katastrofu pārvaldīšanas likumā

****** Ārstniecības likumā

****** Krimināllikumā

****** Likumā par ārkārtas situāciju un izņēmuma stāvokli
...
*** Cik tālu sniedzas pirmās palīdzības sniegšana negadījuma vietā?

****** Novērst cietušo apdraudošos faktorus, izsaukt Ātro palīdzību, palikt ar cietušo, kamēr tā atbrauc

****** Novērst cietušo apdraudošos faktorus, apturēt dzīvībai bīstamu asiņošanu, izsaukt Ātro palīdzību, palikt ar cietušo, kamēr tā atbrauc, veikt citas tehniski vienkāršas lietas

****** Novērst cietušo apdraudošos faktorus, apturēt dzīvībai bīstamo asiņošanu, veikt citas tehniski vienkāršas lietas, izsaukt Ātro palīdzību, palikt kopā ar cietušo, kamēr tā atbrauc

****** Novērst cietušo apdraudošos faktorus, apturēt dzīvībai bīstamo asiņošanu, izsaukt Ātro palīdzību un, ja nepieciešams, veikt atdzīvināšanas pasākumus

****** Glābējam jāizlemj pašam, vai viņš ir spējīgs veikt atdzīvināšanas pasākumus, vai tikai mēģināt apturēt asiņošanu, izsaukt Ātro palīdzību, palikt ar cietušo, kamēr tā atbrauc, un veikt citas tehniski vienkāršas lietas
...
*** Izdzīvošanas ķēde uz ielas ietver sevī: 

****** Agrīno atpazīšanu un palīdzības izsaukšanu, atdzīvināšanas pasākumus un defibrilāciju

****** Agrīno atpazīšanu un palīdzības izsaukšanu, atdzīvināšanas pasākumus

****** Atdzīvināšanas pasākumus un defibrilāciju

****** Agrīno atpazīšanu un palīdzības izsaukšanu, atdzīvināšanas pasākumus, defibrilāciju un aprūpi pēc reanimācijas

****** Atdzīvināšanas pasākumus, defibrilāciju un aprūpi pēc reanimācijas
...
*** Agrīno atdzīvināšanas pasākumu galvenais mērķis ir:
...
****** Vinnēt laiku un, ja izdosies, – iedarbināt sirdi.

****** Sagatavot cietušo neatliekamās medicīniskās palīdzības pasākumiem
...
*** Saskaņā ar Starptautiskā Sarkanā Krusta un Sarkanā Pusmēness nacionālo biedrību federācijas Pasaules katastrofu ziņojumu, lai katastrofa tiktu iekļauta datu bāzē, bojāgājušo skaitam jāpārsniedz:
...
*** Katastrofu medicīna ir disciplīna, kas izriet no:

****** Apvienoto Nāciju Organizācijas Statūtos noteiktiem principiem

****** Neatliekamās medicīniskās palīdzības un katastrofu pārvaldības savienības

****** Pasaules Veselības Organizācijas reakcijām uz ārkārtas situācijām veselības jomā

****** Kara lauka medicīnas un neatliekamās medicīniskās palīdzības pamatprincipiem

****** Valsts veselības aprūpes sistēmas funkcionēšanas pēc ārkārtas situācijas vai izņēmuma stāvokļa izsludināšanas
...
*** Katastrofu pārvaldīšanas cikls secīgi sastāv no:

****** Profilakses un ietekmes mazināšanas fāzes un Gatavības fāzes

****** Profilakses un ietekmes mazināšanas, Gatavības un Atbildes fāzēm

****** Profilakses un ietekmes mazināšanas, Gatavības, Atbildes un Atgūšanās fāzēm

****** Gatavības un Atbildes fāzēm

****** Gatavības, Atbildes un Atgūšanās fāzēm
...
*** Apvienoto Nāciju Organizācijas Brīvprātīgo programmas dalībnieki piedalās:

****** Starptautiskās miera uzturēšanas operācijās, kuru mērķis ir miera atjaunošana un uzturēšana konflikta zonā, kurās iesaistītais personāls nav tiesīgs piedalīties karadarbībā

****** Starptautiskas miera uzturēšanas operācijās, kuru mērķis ir miera atjaunošana un uzturēšana konflikta zonās, kurās iesaistītajam personālam ir tiesības piedalīties karadarbībā

****** Starptautiskās nabadzības mazināšanas, demokrātiskās pārvaldības ieviešanas, enerģētikas un vides attīstīšanas, krīžu novēršanas un veselības aprūpes pakalpojumu pieejamības veicināšanas programmās

****** Starptautiskās glābšanas operācijās, kuru mērķis ir dabas katastrofu seku likvidēšana, civiliedzīvotāju evakuācija no apdraudētajām teritorijām vai līdzīga rakstura darbību veikšana
...
****** Starptautiskās militārās operācijās, kuru mērķis ir īstenot Apvienoto Nāciju Organizācijas dalībvalstu tiesības uz kolektīvo pašaizsardzību, kā noteikts Apvienoto Nāciju Organizācijas Statūtu 51. pantā
...
*** Kas ir Miera korpuss (Peace Corps )? 

****** Starptautiski Apvienoto Nāciju Organizācijas miera uzturēšanas operāciju spēki, kuru mērķis ir miera atjaunošana un uzturēšana konflikta zonā

****** Brīvprātīgo organizācija, kas ir pārmaiņu veidotāji, lai panāktu pozitīvas pārmaiņas, palīdzētu atgūties no attīstības un veselības neveiksmēm, atbalstītu jauno paaudzi

****** Kristiešu apvienība ticības un tradīciju stiprināšanai un atbalsta sniegšanai trūkumcietējiem visa pasaulē

****** Eiropas Savienības programma palīdzības projektu īstenošanai Āfrikas, Āzijas un Dienvidamerikas kontinentu valstīs

****** ASV bāzēta sabiedriskā kustība, kuras mērķi ir miera iniciatīvu īstenošana, konfliktu novēršana un to seku likvidēšana
...
****** Kristiešu apvienība ticības un tradīciju stiprināšanai un atbalsta sniegšanai trūkumcietējiem visā pasaulē

****** Eiropas Savienības programma palīdzības projektu īstenošanai Āfrikas, Āzijas un Dienvidamerikas kontinentu valstīs

****** ASV bāzēta sabiedriskā kustība, kuras mērķis ir miera iniciatīvu īstenošana, konfliktu novēršana un to seku likvidēšana

* 11. tēma

***    

Kuras no nosauktajām ir starptautiskās miera uzturēšanas operācijas, kuru mērķis ir miera atjaunošana un uzturēšana konflikta zonās, kurās iesaistītais personāls nav tiesīgs piedalīties karadarbībā, izņemot, ja tas nepieciešams pašaizsardzības nolūkos?  

  

           [DB1]  Undiņa, domāju, ka šim un nākamajam jautājumam jāliek Multiple choice un pareizā atbilde jāsadala atsevišķi - katra pareizā operācija kā atsevišķa atbilde, lai jautājums daudzskaitlī nesaka priekšā, kura ir pareizā atbilde.         
...
Kuras no nosauktajām ir starptautiskās miera uzturēšanas operācijas, kuru mērķis ir miera atjaunošana un uzturēšana konflikta zonās, kurās iesaistītajam personālam ir tiesības piedalīties karadarbībā?
...
*** Kura no nosauktajām ir starptautiskā glābšanas operācija, kuru mērķis ir dabas katastrofu seku likvidēšana, civiliedzīvotāju evakuācija no apdraudētajām teritorijām vai līdzīga rakstura darbību veikšana? 
...
*** Kura no nosauktajām ir starptautiskā glābšanas operācija, kuras mērķis ir dabas katastrofu seku likvidēšana, civiliedzīvotāju evakuācija no apdraudētajām teritorijām vai līdzīga rakstura darbību veikšana? 
...
*** Kura no nosauktajām ir starptautiskā militārā operācija, kuras mērķis ir īstenot Apvienoto Nāciju Organizācijas dalībvalstu tiesības uz kolektīvo pašaizsardzību, kā noteikts Apvienoto Nāciju Organizācijas Statūtu 51. pantā?
...
*** Ko NATO nodrošināja ANO humānas palīdzības misijā pēc 2005. gada zemestrīces Kašmirā?

****** Sabiedroto bruņoto spēku vienības un tehniku darbam katastrofas seku likvidēšanā

****** Drošību un sabiedrisko kārtību teritorijā, kuru bija skarusi zemestrīce, par kuras piederību pastāv konflikts starp Pakistānu un Indiju

****** Gaisa tiltu ar dalībvalstu transporta lidmašīnām, nodrošinot humānas palīdzības kravu nepārtrauktu piegādi zemestrīcē cietušajiem

****** Mieru teritorijā, par kuras piederību pastāv konflikts starp Pakistānu un Indiju

****** Sabiedroto dalībvalstu palīdzības spēju apzināšanu un apvienošanu
...
****** Gaisa tiltu ar dalībvalstu transporta lidmašīnām, nodrošinot humānās palīdzības kravu nepārtrauktu piegādi zemestrīcē cietušajiem
...
*** Ko NATO nodrošināja ANO humānās palīdzības misijā pēc 2005. gada zemestrīces Kašmirā?

****** Sabiedroto bruņoto spēku vienības un tehniku darbam katastrofas seku likvidēšanā

****** Drošību un sabiedrisko kārtību teritorijā, kuru bija skārusi zemestrīce, par kuras piederību pastāv konflikts starp Pakistānu un Indiju
...
*** Kuri faktori noteica Ebolas epidēmijas sākumu Rietumāfrikā, 2014. gada februārī? 
...
****** Visi augstāk uzskaitītie faktori
...
*** Lai apturētu Ebolas epidēmijas izplatību, PVO noteica galveno starptautiskās misijas uzdevumu:

****** Nepieļaut izplatīšanos uz citām valstīm

****** Pārtraukt pārnešanu no cilvēka uz cilvēku

****** Nodrošināt pietiekamu daudzumu aizsarglīdzekļu

****** Pārtraukt medības un citus iespējamos kontaktus ar savvaļas dzīvniekiem

****** Izglītot sabiedrību vietējās valodās
...
****** Nepieļaut epidēmijas izplatīšanos uz citām valstīm

****** Pārtraukt vīrusi pārnešanu no cilvēka uz cilvēku
...
****** Pārtraukt vīrusa pārnešanu no cilvēka uz cilvēku
...
*** PVO noteiktie galvenie starptautiskās misijas Ebolas likvidēšanai rīcības pamatprincipi:

****** Riska faktoru identificēšana un mazināšana, kontaktu ar savvaļas dzīvniekiem pārtraukšana, apbedīšanas un pārapbedīšanas droša prakse, sabiedrības izglītošana

****** Gadījumu identifikācija, kontaktpersonu izsekošana, izolēšana un aprūpe, stingra infekcijas kontroles ievērošana slimnīcās, sabiedrības izglītošana

****** Veselības aprūpes darbinieku aizsardzība, stingra infekcijas kontroles ievērošana slimnīcās, sabiedrības izglītošana

****** Tiešas saskarsmes kontaktu nepieļaušana, gadījumu identifikācija un izolēšana, apbedīšanas un pārapbedīšanās droša prakse

****** Izplatības uz citām valstīm nepieļaušana, gadījumu identifikācija un izolēšana, sabiedrības izglītošana
...
https://youtu.be/nKvV1nDdSD4Avots: LTV raidījuma "Rīta panorāmas" rubrika "Pirmās palīdzības ABC". Asiņošana. 14.07.2017 
...
Video angļu valodā papildu informācijai:https://youtu.be/XVqbGUYMKXoAvots: iPatientCare. First Aid Info - Abdominal Pain. 08.04.2016

** Cukura diabēts

 Ikvienai cilvēka šūnai nepieciešama enerģija, kuru nodrošina ar uzturu uzņemts cukurs (glikoze). Lai šis process noritētu, nepieciešams hormons – insulīns, kuru ražo aizkuņģa dziedzerī. Ja cilvēkam trūkst insulīns, glikoze paliek asinīs, attīstās slimība – cukura diabēts. Glikozes līmeņa mazināšanai cukura diabēta pacienti ikdienā injicē insulīnu, kuru pārdozējot vai laikus nepaēdot var attīstīties hipoglikēmija – nepietiekams glikozes (cukura) daudzums asinīs. Cukura līmeņa pazemināšanās asinīs var izraisīt dzīvībai bīstamu stāvokli, galvas smadzeņu un citu orgānu šūnas “paliek badā”, attīstās neatgriezeniskas izmaņas.
...
Video: https://www.youtube.com/watch?v=zFjYw8Sco2s Avots: Latvijas diabēta federācija. Cukura diabēts un hipoglikēmija. 16.06.2022 

** Juridiskais pamatojums pirmās palīdzības sniegšanai
...
** Dzīvības glābšanas ABC algoritma sastāvdaļas. Tā nozīme un vieta dzīvības glābšanas ķēdē. ABC shēma
...
Atdzīvināšanas pasākumu praktiskai īstenošanai un apmācībai tiek izmantots starptautiski atzīts Dzīvības glābšanas ABC algoritms, kas nodrošina vienotu pasākumu veikšanas secību un to iekļaušanu dzīvības glābšanas ķēdē.
...
** Rīcība negadījuma vietā. ABC praktiskais demonstrējums
 ...
 ABC algoritma praktiskā pielietošana
...
5. Atbrīvojiet elpceļus, atliecot galvu un paceļot zodu.
...
Video: https://youtu.be/G6ww1-13xqs Avots: LTV raidījuma "Rīta panorāmas" rubrika "Pirmās palīdzības ABC". Pareiza sānu poza. 13.07.2017
...
** Civilās aizsardzības sadarbība divpusējo līgumu ietvaros, sadarbība Baltijas jūras reģionā
...
Organizācija to var praktiski panākt ar miera uzturētāju nosūtīšanu uz konflikta zonu, piešķirot viņu misijai ANO Drošības padomes mandātu. Rīkojoties saskaņā ar Apvienoto Nāciju Organizācijas Statūtu VII nodaļu, Drošības Padome pieņem lēmumu, ka:
...
Ekonomikas ministrija – katastrofas, kuras saistītas ar enerģijas ražošanas vai distribūcijas infrastruktūru (piemēram, gāzes noplūde maģistrālajos gāzes vados, enerģijas ražošanas iekārtu, HES infrastruktūras avārija, elektrotīklu bojājumi).
...
** Paaugstinātas bīstamības objektu saraksts - izvilkums, daži piemēri:
 ...
 https://likumi.lv/ta/id/301571-paaugstinatas-bistamibas-objektu-saraksts
...
Meteoroloģiskā brīdināšana: https://videscentrs.lvgmc.lv/

Valsts agrīnās brīdināšanas sistēma – autonomi funkcionējoša tehnoloģiska sistēma vai šādu sistēmu kopums, kas nodrošina agrīno brīdināšanu. Meteoroloģiskā brīdinājuma zīmes: 
...
Vietējas nozīmes paaugstinātas bīstamības objekts4. solis ja bīstamā ķīmiskā viela ir iekļauta noteikumos Nr.563 pielikuma 2.tabulā, un objektā esošo bīstamo ķīmisko vielu daudzumi ir vienādi vai lielāki par minētajā tabulā norādītajiem klasificējošiem daudzumiem, tad objekts ir pieskaitāms vietējas nozīmes paaugstinātas bīstamības objektam5. solis ja bīstamā ķīmiskā viela nav iekļauta noteikumu Nr.563 pielikuma 2.tabulā, bet ir klasificēta, kā bīstama, tad pārbaudām kādai bīstamības klasei atbilst bīstamā ķīmiskā viela, ņemot vērā regulā Nr.1272/2008 VI PIELIKUMĀ norādīto.
...
Piemēri - mazsalas vīrusa uzliesmojums Eiropā; Ebolas vīrusa aizsardzības pasākumi un simptomi; Covid-19.

** Rīcība terora aktu gadījumā

 ESIET VĒRĪGS!

Jāpievērš uzmanība avārijas izejām un telpām, kurās iespējams patverties; Jāturas tālāk no logiem un stiklotām durvīm, jo vairums upuru iet bojā no šķembām; Pievērsiet uzmanību apkārt notiekošajam, jo ir iespējami vairāki atkārtoti sprādzieni vai uzbrukumi; Ja izsludināta evakuācija, nekavējoties meklējiet drošu patvēruma vietu.

PAMETIET APDRAUDĒJUMA VIETU

Jāņem vērā, ka pamest terora akta vietu vislielākās iespējas ir tieši pirmajās minūtēs; Lai to izdarītu, jāizmanto tuvākās evakuācijas izejas; Noteikti nevajag censties meklēt savas mantas – visu, kas nav rokās, jāatstāj, jo neviena lieta nekad nebūs vērtīgāka par Jūsu dzīvību.

SLĒPIETIES

Ja nav iespējams aizbēgt, tad jānoslēpjas; Jāizslēdz telefonam skaņa un jāpaļaujas uz pretterorisma pasākumos iesaistīto institūciju darbu; Esot drošībā, ziņojiet par savu atrašanās vietu pretterorisma pasākumos iesaistītajām institūcijām.

PALĪDZIET CITIEM IZGLĀBTIES

Ja jūs redzat, ka cilvēks līdzās ir šoka stāvoklī un nebēg, vai ir dezorientēts, palīdziet viņam izglābties; Iespēju robežās sniedziet pirmo palīdzību.

JA ESAT KĻUVIS PAR ĶĪLNIEKU

Gadījumā, ja terorists draud ar ieroci, jāpilda visas viņa prasības; Klausieties un centieties iegaumēt, ko teroristi runā, kā viņi izskatās, taču tas jādara nemanāmi; Taupiet spēkus, neveiciet straujas kustības, nepiesaistiet sev lieku uzmanību.

PĒC APDRAUDĒJUMA

Kad esat nonācis drošā vietā, meklējiet palīdzību, ja tāda nepieciešama; Piesakieties liecību sniegšanai; Atcerieties, ka apšaude vai sprādzieni var atkārtoties, tāpēc nav ieteicams pievienoties lieliem pūļiem, kā arī izmantot sabiedrisko transportu.
...
* Radiācijas, bīstamo ķīmisko vielu un bioloģisko aģentu ietekme uz cilvēka organismu, bīstamo ķīmisko vielu klasifikācija, uzglabāšana un pārvadāšana
...
** Pirmā palīdzība un neatliekamā medicīniskā palīdzība. Juridiskā atbildība tās sniedzējiem
...
Katastrofu medicīna ir unikāla medicīnas specialitāšu vidū ar to, ka atšķirībā no citām specializācijas jomām, katastrofu medicīnas speciālists nepraktizē pilnu specialitātes apjomu ikdienā, bet tikai ārkārtas gadījumos, viņš cer, ka nekad nepielietos profesionālai sertifikācijai nepieciešamās prasmes. Šī iemesla dēl katastrofu medicīnas struktūrām ir ārkārtīgi svarīgas regulāras mācības kopīgi ar citiem dienestiem, kas piedalās katastrofu pārvaldīšanā un to seku likvidēšanā. Lai sasniegtu nepieciešamo gatavības pakāpi, katastrofu medicīnas speciālisti nodarbojas ar valsts un privātās politikas, likumdošanas, katastrofu plānošanas un avāriju seku likvidēšanas izstrādi.
...
* Digitālā laboratorija

*** Lai atvērtu spēli, Jums vispirms jālejupielādē savā datorā programma Minecraft Education Edition. Mapē "Pirmā pamācība" pieejama instrukcija un ievadspēle, lai apgūtu pirmos soļus darbā ar Minecraft. Spēles "Civilās aizsardzības sistēma" fails pieejams mapē "Spele_CA_sistema". 

* Digitālā laboratorija

*** Lai atvērtu spēli, Jums vispirms jālejupielādē savā datorā programma Minecraft Education Edition.Mapē "Pirmā pamācība" pieejama instrukcija un ievadspēle, lai apgūtu pirmos soļus darbā ar Minecraft.Spēles "Katastrofas seku likvidēšana" fails pieejams mapē "Spele_Katastrofas_seku_likvidesana".

* Pasniedzēja resursi

* Pasniedzēju resursi par testiem

*** Lūgums šo resursu atstāt paslēptu no studentiem!
...
*** 6.-8. tēmas Minecraft apvienotā pasaule vēl ir izstrādes stadijā. Tiklīdz tā būs izstrādāta, tiks noorganizēts spēles ievietošanas process.
